...
const Home = () => {
  ...
  return (
    <>
      ...
      <main className="container  rounded   mx-auto bg-black p-4 h-[50vh] w-full">
        <div className="flex items-center justify-between">
          <button
            className="bg-blue-500 hover:bg-blue-700 rounded p-4 text-white font-bold"
            id="upload-button"
            onClick={showPop}
          >
            Upload File
          ...
          <h1 className="text-xl font-bold">
            Welcome ,<span className="text-blue-600 underline">{username}</span>
          </h1>
          <button
        ...
        <div className="files overflow-y-auto  h- flex flex-col gap-4 mt-4">
          {files.map((file, idx) => {
            return (
              <div
                key={idx}
      ...
      <footer className=" bg-gray-800 w-full fixed absolute bottom-0 flex justify-center items-center">
